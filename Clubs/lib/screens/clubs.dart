  ...
  Widget build(BuildContext context) {
    ...
    final nombreclub = TextFormField(
        ...
        decoration: InputDecoration(
          ...
          hintText: "Escriba el nombre de su club",
    ...
    final direccionclub = TextFormField(
        ...
        decoration: InputDecoration(
          ...
          contentPadding: EdgeInsets.fromLTRB(20, 15, 20, 15),
          hintText: "Escriba la direccion de su club",
          hintStyle: TextStyle(color: Colors.grey),
          border: OutlineInputBorder(
            borderRadius: BorderRadius.circular(10),
          ),
    ...
    final telefonoclub = TextFormField(
        ...
        decoration: InputDecoration(
          ...
          contentPadding: EdgeInsets.fromLTRB(20, 15, 20, 15),
          hintText: "Escriba el telefono de su club",
          hintStyle: TextStyle(color: Colors.grey),
          border: OutlineInputBorder(
            borderRadius: BorderRadius.circular(10),
          ),
    ...
    final horarioclub = TextFormField(
        ...
        decoration: InputDecoration(
          ...
          contentPadding: EdgeInsets.fromLTRB(20, 15, 20, 15),
          hintText: "Escriba el horario de su club ejemplo 12:00pm",
          hintStyle: TextStyle(color: Colors.grey),
          border: OutlineInputBorder(
            borderRadius: BorderRadius.circular(10),
          ),
